...
Note that adult Delta Smelt can linger for more than a year (i.e, 1+ year old Delta Smelt). 2-year old Delta Smelt have even been observed in the past. This is why the first adult smelt can sometimes show up in June or July in the table. This phenomenon of 1+ year old Delta Smelt were more common in the 1990s before the Pelagic Organism Decline.
...
ggplot(data_deltasmelt_long %>% filter(year(Date)==2012), aes(x=Date, y=Length)) + theme_bw() +
  geom_point(size=1, shape=16,alpha=0.2) + labs(title="2012 Delta Smelt FL Distribution",x="Date")
...
data_deltasmelt_juvenile_sum <- left_join(data_deltasmelt_juvenile_sum,data_deltasmelt_juvenile %>% group_by(broodyear) %>% summarise(sample_size=sum(Count)))

kable(data_deltasmelt_juvenile_sum,col.names = c("Cohort Year","0.0%",
                                              "5.0%","10.0%", "90.0%",
                                              "95.0%","100.0%","Sample size"))
...
kable(data_deltasmelt_larvae_sum,col.names = c("Cohort Year","0.0%",
                                              "5.0%","10.0%", "90.0%",
                                              "95.0%","100.0%","Sample size"))
