...
data_longfinsmelt_adult_sum$date<-format(data_longfinsmelt_adult_sum$date, format="%m-%d-%Y")
...
data_longfinsmelt_juvenile_sum$date<-format(data_longfinsmelt_juvenile_sum$date, format="%m-%d-%Y")
...
data_longfinsmelt_larvae_sum$date<-format(data_longfinsmelt_larvae_sum$date, format="%m-%d-%Y")
