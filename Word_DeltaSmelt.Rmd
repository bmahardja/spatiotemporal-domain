---
title: "Delta Smelt Spatiotemporal Domain"
...
data_deltasmelt_adult_sum$date<-format(data_deltasmelt_adult_sum$date, format="%m-%d-%Y")
...
data_deltasmelt_juvenile_sum$date<-format(data_deltasmelt_juvenile_sum$date, format="%m-%d-%Y")
...
data_deltasmelt_larvae_sum$date<-format(data_deltasmelt_larvae_sum$date, format="%m-%d-%Y")
